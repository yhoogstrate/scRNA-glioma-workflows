...
obj__yuan__PJ016$celltype.annotated.venteicher <- NA
...
obj__yuan__PJ016$celltype.annotated.venteicher = ifelse(obj__yuan__PJ016$seurat_clusters %in% 
                                            c(3,0,2,6,1,4),
                                          "Astro. program",obj__yuan__PJ016$celltype.annotated.venteicher)
```


```{r, show}
Seurat::DimPlot(obj__yuan__PJ016, reduction = "umap", label = TRUE, pt.size = .6, group.by = "celltype.annotated.venteicher")
...
obj__yuan__PJ016$celltype.annotated.venteicher = ifelse(obj__yuan__PJ016$seurat_clusters %in% 
                                            c(7, 10, 11, 5, 8 ,9),
                                          "Stemness. program",obj__yuan__PJ016$celltype.annotated.venteicher)
```
