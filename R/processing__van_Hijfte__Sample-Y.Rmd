...
```{r}
obj__van_hijfte__sample_y <- RunPCA(obj__van_hijfte__sample_y, features = VariableFeatures(object = obj__van_hijfte__sample_y))

ElbowPlot(obj__van_hijfte__sample_y, ndims = round(obj__van_hijfte__sample_y@misc$pca.informative.components * 4/3) + 1)

# @todo add marker colors
VizDimLoadings(obj__van_hijfte__sample_y, dims = 1:6, reduction = "pca")
...
```{r}
obj__van_hijfte__sample_y <- FindNeighbors(obj__van_hijfte__sample_y, dims = 1:obj__van_hijfte__sample_y@misc$pca.informative.components)
obj__van_hijfte__sample_y <- FindClusters(obj__van_hijfte__sample_y,
...
```{r}
obj__van_hijfte__sample_y <- RunUMAP(obj__van_hijfte__sample_y, dims = 1:obj__van_hijfte__sample_y@misc$pca.informative.components)
```
