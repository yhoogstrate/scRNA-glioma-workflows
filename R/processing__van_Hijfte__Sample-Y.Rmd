...
```{r}
obj__van_hijfte__sample_y <- Seurat::RunPCA(obj__van_hijfte__sample_y, features = Seurat::VariableFeatures(object = obj__van_hijfte__sample_y), verbose=F, seed.use=obj__van_hijfte__sample_y@misc$random.seed)
...
```{r}
obj__van_hijfte__sample_y <- Seurat::FindNeighbors(obj__van_hijfte__sample_y, dims = 1:obj__van_hijfte__sample_y@misc$pca.informative.components)
obj__van_hijfte__sample_y <- Seurat::FindClusters(obj__van_hijfte__sample_y,
...
```{r}
obj__van_hijfte__sample_y <- Seurat::RunUMAP(obj__van_hijfte__sample_y, dims = 1:obj__van_hijfte__sample_y@misc$pca.informative.components)
```
