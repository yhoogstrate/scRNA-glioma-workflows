...
```{r}
obj__van_hijfte__sample_y$celltype <- ifelse(is.na(obj__van_hijfte__sample_y$celltype),"N/A",obj__van_hijfte__sample_y$celltype)

Seurat::DimPlot(obj__van_hijfte__sample_y)
Seurat::FeaturePlot(obj__van_hijfte__sample_y, features=c('RBFOX3'))

Seurat::DotPlot(obj__van_hijfte__sample_y, features=list('neuron-marker'=c('RBFOX3'),
                                                         'NEU'=c('ADCY1','GRIA3','STX1A','SYN1','PCLO','PAK3','LRRC4','ARHGAP35'),
                                                         'NES'=c('KIN','CHEK2','MCMBP','EEF2K','HIRA')), group.by = "seurat_clusters")
